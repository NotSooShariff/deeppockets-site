  ...
  return (
    <div>
        ...
        <div class="flex flex-col justify-center items-center">
          ...
          <p class="mt-5 lg:px-64 text-center text-xl text-white opacity-70">
          We draw inspiration from the 'Drake Effect' - a term coined to describe the significant impact Drake has had on the online gaming world, particularly on Stake.com, where his username 'deeppockets6' became synonymous with high-stakes play and record-breaking wagers. Our memecoin celebrates this spirit, inviting you to be part of a community that's bold, daring, and unapologetically ambitious. Our journey is ambitious and exhilarating. Starting with our launch on Solana, we aim to develop a strong community, introduce innovative features, and establish partnerships in the entertainment and gaming industries. Our journey is ambitious and exhilarating. Starting with our launch on Solana, we aim to develop a strong community, introduce innovative features, and establish partnerships in the entertainment and gaming industries.
          </p>
          <button
            type="button"
